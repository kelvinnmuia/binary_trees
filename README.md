...
The project introduced me to binary trees in C programming language.
...
```
  ...
  * [101-binary_tree_levelorder.c](./101-binary_tree_levelorder.c): A C function that goes through a binary tree using level-order traversal.
...
```
  ...
  * [103-binary_tree_rotate_left.c](./103-binary_tree_rotate_left.c): A C function that performs a left-rotation on a binary tree.
...
```
  ...
  * [104-binary_tree_rotate_right.c](./104-binary_tree_rotate_right.c): A C function that performs a right-rotation on a binary tree.
...
```
  ...
  * [110-binary_tree_is_bst.c](./110-binary_tree_is_bst.c): A C function that checks if a binary tree is a valid Binary Search Tree.
...
```
  ...
  * [111-bst_insert.c, 0-binary_tree_node.c](./111-bst_insert.c, 0-binary_tree_node.c): A C function that inserts a value in a Binary Search Tree.
...
```
  ...
  * [112-array_to_bst.c](./112-array_to_bst.c): A C function that builds a Binary Search Tree from an array.
...
```
  ...
  * [113-bst_search.c](./113-bst_search.c): A C function that searches for a value in a Binary Search Tree.
...
```
  ...
  * [114-bst_remove.c](./114-bst_remove.c): A C function that removes a node from a Binary Search Tree.
...
```
  ...
  * [120-binary_tree_is_avl.c](./120-binary_tree_is_avl.c): A C function that checks if a binary tree is a valid AVL Tree.
...
```
  ...
  * [121-avl_insert.c](./121-avl_insert.c): A C function that inserts a value in an AVL Tree.
...
```
  ...
  * [123-avl_remove.c](./123-avl_remove.c): A C function that removes a node from an AVL tree.
  * [14-binary_tree_balance.c](./14-binary_tree_balance.c)
  * [103-binary_tree_rotate_left.c](./103-binary_tree_rotate_left.c)
  * [104-binary_tree_rotate_right.c](./104-binary_tree_rotate_right.c)
...
```
  ...
  * [124-sorted_array_to_avl.c](./124-sorted_array_to_avl.c): A C function that builds an AVL tree from an array.
  * [0-binary_tree_node.c](./0-binary_tree_node.c): A C function that builds an AVL tree from an array.
...
```
  ...
  * [130-binary_tree_is_heap.c](./130-binary_tree_is_heap.c): A C function that checks if a binary tree is a valid Max Binary Heap.
...
```
  ...
  * [131-heap_insert.c](./131-heap_insert.c): A C function that inserts a value in Max Binary Heap.
  * [0-binary_tree_node.c](./0-binary_tree_node.c)
...
```
  ...
  * [132-array_to_heap.c](./132-array_to_heap.c): A C function that builds a Max Binary Heap tree from an array.
...
```
  ...
  * [133-heap_extract.c](./133-heap_extract.c): A C function that extracts the root node of a Max Binary Heap.
...
```
  ...
  * [134-heap_to_sorted_array.c](./134-heap_to_sorted_array.c): A C function that converts a Binary Max Heap to a sorted array of integers.
